...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/TeamEiva/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/TheEiva"),
        InlineKeyboardButton(
            strings["btn_group"], url="https://t.me/EivaSupport"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add EivaX to your group",
            url=f"https://telegram.me/EivaXbot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/EivaXbot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
